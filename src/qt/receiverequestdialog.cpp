...
#include "config/sheet-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSheetURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SheetUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSheetURI(info));
}
