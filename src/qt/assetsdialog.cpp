...
void AssetsDialog::setupAssetControlFrame(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->labelAssetControlFeatures->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlQuantityText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlAmountText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlFeeText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlAfterFeeText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlBytesText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlLowOutputText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlChangeText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetControlAutomaticallySelected->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->checkBoxAssetControlChange->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
    } else {
...
void AssetsDialog::assetControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelAssetControlChangeLabel->setText(tr("Warning: Invalid Sheet address"));
        }
        else // Valid address
        {
