...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(SheetUnits::SHTX),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    if (darkModeEnabled) {
        ui->assetBalanceLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->shtxBalancesLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelBalanceText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelPendingText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelImmatureText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelTotalText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelSpendable->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelWatchonly->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->recentTransactionsLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
    } else {
        ui->assetBalanceLabel->setStyleSheet(STRING_LABEL_COLOR);
        ui->shtxBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->shtxBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SheetUnits::formatWithUnit(unit, balance, false, SheetUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SheetUnits::formatWithUnit(unit, unconfirmedBalance, false, SheetUnits::separatorAlways));
    ui->labelImmature->setText(SheetUnits::formatWithUnit(unit, immatureBalance, false, SheetUnits::separatorAlways));
    ui->labelTotal->setText(SheetUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, SheetUnits::separatorAlways));
    ui->labelWatchAvailable->setText(SheetUnits::formatWithUnit(unit, watchOnlyBalance, false, SheetUnits::separatorAlways));
    ui->labelWatchPending->setText(SheetUnits::formatWithUnit(unit, watchUnconfBalance, false, SheetUnits::separatorAlways));
    ui->labelWatchImmature->setText(SheetUnits::formatWithUnit(unit, watchImmatureBalance, false, SheetUnits::separatorAlways));
    ui->labelWatchTotal->setText(SheetUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, SheetUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("SHTX")
    updateDisplayUnit();
}
