...
void WalletView::setSheetGUI(SheetGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? SheetGUI::HD44_ENABLED : _walletModel->hdEnabled() ? SheetGUI::HD_ENABLED : SheetGUI::HD_DISABLED);
