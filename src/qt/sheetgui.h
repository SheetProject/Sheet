...
#ifndef SHEET_QT_SHEETGUI_H
#define SHEET_QT_SHEETGUI_H
...
/**
  Sheet GUI main class. This class represents the main window of the Sheet UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SheetGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SheetGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~SheetGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a sheet wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
