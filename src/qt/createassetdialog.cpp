...
void CreateAssetDialog::setUpValues()
{
    ...
    QStringList list;
    list.append(tr("Main Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::ROOT)) + ")");
    list.append(tr("Sub Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::SUB)) + ")");
    list.append(tr("Unique Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::UNIQUE)) + ")");
    list.append(tr("Messaging Channel Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::MSGCHANNEL)) + ")");
    list.append(tr("Qualifier Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::QUALIFIER)) + ")");
    list.append(tr("Sub Qualifier Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::SUB_QUALIFIER)) + ")");
    list.append(tr("Restricted Asset") + " (" + SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetBurnAmount(AssetType::RESTRICTED)) + ")");
...
void CreateAssetDialog::setupCoinControlFrame(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->labelCoinControlFeatures->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlQuantityText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlAmountText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlFeeText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlAfterFeeText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlBytesText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlLowOutputText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlChangeText->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelCoinControlAutomaticallySelected->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->checkBoxCoinControlChange->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
    } else {
...
void CreateAssetDialog::setupAssetDataView(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->assetTypeLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->assetNameLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->addressLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->quantityLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->unitsLabel->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelVerifierString->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->ipfsBox->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
        ui->reissuableBox->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
    } else {
...
void CreateAssetDialog::setupFeeControl(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->labelFeeHeadline->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelSmartFee3->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->radioSmartFee->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->radioCustomFee->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->checkBoxMinimumFee->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
        ui->labelCustomPerKilobyte->setStyleSheet(QString(".QLabel{ %1; }").arg(STRING_LABEL_COLOR_DARK));
    } else {
                                 ...
                                 const CAmount& watchBalance, const CAmount& watchUnconfirmedBalance, const CAmount& watchImmatureBalance)
{
    ...
    {
        ui->labelBalance->setText(SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), balance));
    }
}
...
void CreateAssetDialog::CheckFormState()
{
    ...
    if (!(ui->addressText->text().isEmpty() || IsValidDestination(dest)) && assetNameValid) {
        ...
        showMessage(tr("Warning: Invalid Sheet address"));
        return;
    }
...
void CreateAssetDialog::onCreateAssetClicked()
{
    ...
    QString amount = "<b>" + QString::fromStdString(ValueFromAmountString(GetBurnAmount(type), 8)) + " SHTX";
    amount.append("</b>");
    ...
    if(nFeeRequired > 0)
    {
        ...
        questionString.append(SheetUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), nFeeRequired));
    ...
    for (SheetUnits::Unit u : SheetUnits::availableUnits())
    {
        if(u != model->getOptionsModel()->getDisplayUnit())
            alternativeUnits.append(SheetUnits::formatHtmlWithUnit(u, totalAmount));
    }
    questionString.append(tr("Total Amount %1")
                                  .arg(SheetUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), totalAmount)));
...
void CreateAssetDialog::updateSmartFeeLabel()
{
    ...
    ui->labelSmartFee->setText(SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), feeRate.GetFeePerK()) + "/kB");
...
void CreateAssetDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Sheet address"));
        }
        else // Valid address
        {
...
void CreateAssetDialog::updateFeeMinimizedLabel()
{
    ...
    if (ui->radioSmartFee->isChecked())
        ...
        ui->labelFeeMinimized->setText(SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), ui->customFee->value()) + "/kB");
    }
}
...
void CreateAssetDialog::updateMinFeeLabel()
{
    if (model && model->getOptionsModel())
        ui->checkBoxMinimumFee->setText(tr("Pay only the required fee of %1").arg(
                SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), GetRequiredFee(1000)) + "/kB")
        );
}
