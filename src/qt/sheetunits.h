...
#ifndef SHEET_QT_SHEETUNITS_H
#define SHEET_QT_SHEETUNITS_H
...
/** Sheet unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SheetUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SheetUnits(QObject *parent);

    /** Sheet units.
      @note Source: https://en.sheet.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SHTX,
...
typedef SheetUnits::Unit SheetUnit;

#endif // SHEET_QT_SHEETUNITS_H
