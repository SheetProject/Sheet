...
#ifndef SHEET_QT_GUIUTIL_H
#define SHEET_QT_GUIUTIL_H
...
/** Utility functions used by the Sheet Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "sheet:" URI into recipient object, return true on successful parsing
