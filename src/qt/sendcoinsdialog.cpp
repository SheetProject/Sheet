...
void SendCoinsDialog::setupCoinControl(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ...
        ui->checkBoxCoinControlChange->setStyleSheet(STRING_LABEL_COLOR_DARK);
    } else {
...
void SendCoinsDialog::setupFeeControl(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ...
        ui->labelCustomPerKilobyte->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->radioSmartFee->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->radioCustomFee->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->checkBoxMinimumFee->setStyleSheet(STRING_LABEL_COLOR_DARK);
    } else {
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    processSendCoinsReturn(prepareStatus,
        SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), currentTransaction.getTransactionFee()));
    ...
    for (const SendCoinsRecipient &rcp : currentTransaction.getRecipients())
    {
        ...
        QString amount = "<b>" + SheetUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), rcp.amount);
        amount.append("</b>");
    ...
    if(txFee > 0)
    {
        ...
        questionString.append(SheetUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), txFee));
...
void SendCoinsDialog::processSendCoinsReturn(const WalletModel::SendCoinsReturn &sendCoinsReturn, const QString &msgArg)
{
    ...
    case WalletModel::AbsurdFee:
        msgParams.first = tr("A fee higher than %1 is considered an absurdly high fee.").arg(SheetUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), maxTxFee));
        break;
