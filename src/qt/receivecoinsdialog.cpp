...
void ReceiveCoinsDialog::setupRequestFrame(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->label_5->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->label_2->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->label->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->label_3->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->label_4->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->label_7->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->reuseAddress->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
    } else {
...
void ReceiveCoinsDialog::setupHistoryFrame(const PlatformStyle *platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->label_6->setStyleSheet(STRING_LABEL_COLOR_DARK);
    } else {
...
void ReceiveCoinsDialog::copyURI()
{
    ...
    const QString uri = GUIUtil::formatSheetURI(submodel->entry(sel.row()).recipient);
