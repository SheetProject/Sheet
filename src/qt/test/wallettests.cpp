...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<SheetAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_sheet-qt -platform xcb      # Linux
//     src/qt/test/test_sheet-qt -platform windows  # Windows
//     src/qt/test/test_sheet-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SheetUnits::formatWithUnit(unit, balance, false, SheetUnits::separatorAlways);
    ...
    // Amount input
    SheetAmountField* amountInput = receiveCoinsDialog.findChild<SheetAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: sheet:")) != -1);
