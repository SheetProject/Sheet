// Copyright (c) 2019 The Sheet Core developers
        ...
        platformStyle(_platformStyle)
{
    ...
    if (darkModeEnabled) {
        ui->labelQualifier->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAddress->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssignType->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->labelAssetData->setStyleSheet(STRING_LABEL_COLOR_DARK);
        ui->checkBoxChangeAddress->setStyleSheet(QString(".QCheckBox{ %1; }").arg(STRING_LABEL_COLOR_DARK));
    } else {
