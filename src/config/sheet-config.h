/* src/config/sheet-config.h.  Generated from sheet-config.h.in by configure.  */
/* src/config/sheet-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SHEET_CONFIG_H

#define SHEET_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Sheet Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Sheet Core"
...
#define PACKAGE_BUGREPORT "https://github.com/SheetProject/Sheet/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sheet Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sheet Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sheet"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sheetproject.org/"
