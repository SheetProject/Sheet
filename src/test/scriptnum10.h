...
#ifndef SHEET_TEST_SCRIPTNUM10_H
#define SHEET_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sheet Core 0.10.0, for cross-comparison.
 */
public:
