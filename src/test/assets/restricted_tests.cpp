...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler shtx tx
        CScript shtxTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut shtxOut(1*COIN, shtxTransfer);
        ...
        mutTxTest1.vout.emplace_back(shtxOut);
        ...
        mutTxTest2.vout.emplace_back(shtxOut);
        ...
        mutTxTest3.vout.emplace_back(shtxOut);
        ...
        mutTxTest4.vout.emplace_back(shtxOut);
        ...
        mutTxTest5.vout.emplace_back(shtxOut);
        ...
        mutTxTest6.vout.emplace_back(shtxOut);
        ...
        mutTxTest7.vout.emplace_back(shtxOut);
        ...
        mutTxTest8.vout.emplace_back(shtxOut);
