...
#ifndef SHEETCOIN_ASSET_PROTOCOL_H
#define SHEETCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_SHEET_ASSET SHTXQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_SHEET_ASSET SHTXO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_SHEET_ASSET SHTXR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_SHEET_ASSET SHTXT
...
#endif //SHEETCOIN_ASSET_PROTOCOL_H
