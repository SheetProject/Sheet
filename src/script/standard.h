...
#ifndef SHEET_SCRIPT_STANDARD_H
#define SHEET_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_SHEET_ASSET script that carries data
    /** SHTX END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a sheet address
 */
...
/**
 * Generate a Sheet scriptPubKey for the given CTxDestination. Returns a P2PKH
