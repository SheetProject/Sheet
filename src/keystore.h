...
#ifndef SHEET_KEYSTORE_H
#define SHEET_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/sheet/bips/blob/master/bip-0013.mediawiki
