...
#ifndef SHEET_VALIDATION_H
#define SHEET_VALIDATION_H
...
static const CAmount HIGH_MAX_TX_FEE = 1 * HIGH_TX_FEE_PER_KB;
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for sheet, with 1 minutes block intervals?
