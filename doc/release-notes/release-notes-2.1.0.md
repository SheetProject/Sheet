Sheet Core version *2.1.0* is now available!!
==============

  <https://github.com/SheetProject/Sheet/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/SheetProject/Sheet/commits/release_2.1.0>
