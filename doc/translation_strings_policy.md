...
This document provides guidelines for internationalization of the Sheet Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sheet_en.ts` remains unchanged.
