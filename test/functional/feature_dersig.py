...
class BIP66Test(SheetTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # sheetd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and sheetd produces more specific reject
            # reasons.
