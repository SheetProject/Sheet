...
# TestNode: A peer we use to send messages to sheetd, and store responses.
...
class CompactBlocksTest(SheetTestFramework):
    ...
    # This test actually causes sheetd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sheetd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sheetd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # sheetd will not send blocktxn responses for blocks whose height is
