...
class WalletTest(SheetTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SHTX from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SHTX with subtract fee from amount
        ...
        # Sendmany 10 SHTX with subtract fee from amount
