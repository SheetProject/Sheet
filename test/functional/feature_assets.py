...
class AssetTest(SheetTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("SHEET1", 1000)
        n0.issue("SHEET2", 1000)
        n0.issue("SHEET3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="SHEET*", verbose=False, count=2, start=-2)
        ...
        sheet_assets = n0.listassets(asset="SHEET*", verbose=False, count=2, start=-2)
        assert_equal(len(sheet_assets), 2)
        assert_equal(sheet_assets[0], "SHEET2")
        assert_equal(sheet_assets[1], "SHEET3")
        self.sync_all()
