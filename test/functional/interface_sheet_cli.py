...
class TestSheetCli(SheetTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `sheet-cli getinfo`")
        ...
        self.log.info("Compare responses from `sheet-cli -getinfo` and the RPCs data is retrieved from.")
