...
By default, sheetd will dump mempool on shutdown and
...
class MempoolPersistTest(SheetTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give sheetd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent sheetd from writing mempool.dat to disk. Verify that `savemempool` fails")
