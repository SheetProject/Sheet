...
class TxnMallTest(SheetTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 SHTX:
        ...
        # First: use raw transaction API to send 1240 SHTX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SHTX coin each
        ...
        # Node0's balance should be starting balance, plus 50SHTX for another
        ...
        # Node0's total balance should be starting balance, plus 100SHTX for 
