...
import os
import struct
from test_framework.test_framework import SheetTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(SheetTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that sheet has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("sheetd has not been built with zmq enabled.")
