...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SheetTestFramework
    pass

class ExampleTest(SheetTestFramework):
    # Each functional test is a subclass of the SheetTestFramework class.
    ...
    def custom_method(self):
        ...
        SheetTestFramework class so other tests can use it."""
